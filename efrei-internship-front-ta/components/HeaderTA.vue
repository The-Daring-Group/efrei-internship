<template>
    <div class="tw-bg-gradient-to-r tw-shadow-md tw-text-white tw-from-cyan-500 tw-via-cyan-300 tw-to-sky-600">
        ...
        <nav class="tw-flex tw-flex-row tw-items-center tw-justify-between">
            ...
            <ul class="tw-flex tw-flex-row">
                <li class="hover:tw-bg-sky-800 tw-bg-sky-700 tw-text-sky-200 tw-w-fit tw-p-2 tw-mr-2" v-if="!isConnected"><NuxtLink to="../login">Login</NuxtLink></li>
                <li class="hover:tw-bg-sky-800 tw-bg-sky-700 tw-text-sky-200 tw-w-fit tw-p-2 tw-mr-2" v-else>Disconnect <font-awesome-icon class="tw-ml-0.5" :icon="['fas', 'arrow-right-from-bracket']" /></li>
            </ul>
        </nav>
    </div>
</template>
