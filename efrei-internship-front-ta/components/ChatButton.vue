<template>
    <NuxtLink :to="'/internships/chat/' + userId" class="tw-relative tw-bg-cyan-400 hover:tw-bg-cyan-600 hover:tw-cursor-pointer hover:tw-text-white tw-text-cyan-800 font-bold px-2 py-1 tw-rounded-md tw-w-11 tw-h-10 tw-border-cyan-600 tw-border-2 mr-4">
