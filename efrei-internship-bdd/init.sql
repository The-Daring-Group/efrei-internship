DROP DATABASE IF EXISTS db_efrei_internship;
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ei_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO ei_user;
